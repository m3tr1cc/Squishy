...
const SOAP_WAIST_DEPTH = 0.13
const SOAP_WAIST_CURVE = 3.6
...
export const SOAP_SHARED_CORNER_RADIUS = 0.31
...
export function getSoapShapedPosition(
  ...
  const waist = Math.exp(
    -SOAP_WAIST_CURVE * normalizedX * normalizedX,
  )
